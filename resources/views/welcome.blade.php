        ...
        <div class="col-7 col-md mx-auto">
            <div class="row mb-2">
                <div class="col-4 col-md-2">
                    <img src="{{ asset('img/bhtrade.png') }}" alt="" width="150" height="100">
                </div>
                <div class="col">
            ...
            <form action="{{ route('encuesta.save') }}" method="POST">
                ...
                @foreach ($preguntas as $pregunta)
                    ...
                    @switch($pregunta->type)                       
                        ...
                        @case('Libre')
                            @if($pregunta->id == 38 || $pregunta->id == 37)
                            <div class="col-7 mx-auto card mb-3">
                                ...
                                <div class="card-title">
                                    <div class="form-check">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-11">                                                 
                                                        <textarea class="form-control rounded mt-4" name="question_id[{{ $pregunta->id }}][]" cols="10" rows="2"
                                                            placeholder="escribe tu respuesta" maxlength="255" ></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
