        ...
        <nav class="navbar  bg-body-tertiary" style="background-color: rgb(181, 234, 248);">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="{{ asset('img/trademarket57.png') }}" alt="Logo" width="30" height="24"
    ...
    <div class="container mt-4">
        ...
        <div id="introduccion">
            <section class="bg-white p-4 rounded shadow-lg">
                <p class="fw-bold">
                    ¡Bienvenido(a) estimado(a) colaborador(a) de Trade Market 57!
