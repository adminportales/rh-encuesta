...
<body class="antialiased">
    ...
    <div class="container mt-4">       
        <div class="col-7 col-md mx-auto">
            <div class="row mb-2">
                <div class="col-4 col-md-2">
                    <img src="{{ asset('img/trademarket57.png') }}" alt="" width="150" height="100">
                </div>
                <div class="col">
            ...
            <section class="bg-white p-4 rounded shadow-lg">                                
                <p >
                    ¡Bienvenido(a) estimado(a) colaborador(a) de <span class="fw-bold">TRADE MARKET 57 SA DE CV!</span>
                </p>
                <br>
                ...
                <br>
                <p>
                    Pedimos de tu valioso apoyo con tu respuesta de la manera más honesta y objetiva, recordando que no existen respuestas buenas o malas, ya que buscamos mejorar de manera continua las condiciones laborales de <b>TRADE MARKET 57.</b>
                </p>
                <br>
                <p>
        ...
        <section class=" preguntas mt-4">
            <form action="{{ route('tm57.save') }}" method="POST">
                @csrf
