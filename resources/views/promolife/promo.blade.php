    ...
    <div class="container mt-4">       
        <div class="col-7 col-md mx-auto">
            ...
            <section class="bg-white p-4 rounded shadow-lg">                                
                <p >
                    ¡Bienvenido(a) estimado(a) colaborador(a) de <span class="fw-bold">PROMO LIFE SA DE CV!</span>
                </p>
                <br>
                ...
                <br>
                <p>
                    Pedimos de tu valioso apoyo con tu respuesta de la manera más honesta y objetiva, recordando que no existen respuestas buenas o malas, ya que buscamos mejorar de manera continua las condiciones laborales de <b>PROMO LIFE.</b>
                </p>
                <br>
                <p>
